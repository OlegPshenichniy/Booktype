...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'VideoSettings'
        db.create_table(u'video_videosettings', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('book', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['editor.Book'])),
            ('enabled', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'video', ['VideoSettings'])


    def backwards(self, orm):
        # Deleting model 'VideoSettings'
        db.delete_table(u'video_videosettings')
    ...
    models = {
        ...
        u'video.videosettings': {
            'Meta': {'object_name': 'VideoSettings'},
            'book': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['editor.Book']"}),
