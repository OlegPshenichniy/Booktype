...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'VideoSettings', fields ['book', 'user']
        db.create_unique(u'video_videosettings', ['book_id', 'user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'VideoSettings', fields ['book', 'user']
        db.delete_unique(u'video_videosettings', ['book_id', 'user_id'])
    ...
    models = {
        ...
        u'video.videosettings': {
            'Meta': {'unique_together': "(('user', 'book'),)", 'object_name': 'VideoSettings'},
            'book': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['editor.Book']"}),
